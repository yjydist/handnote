...
| `link_not_allowed` | 任何 `link` (含 GFM autolink literal, 裸 URL 即 link), 非图片 `definition`, footnote reference/definition; 含 mermaid code block 内的 click 指令 / markdown 链接 / 任意大小写的 `img` 节点属性 / URL scheme `https?://` (静态文本校验) |
